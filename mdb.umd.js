...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ...
        : "function" == typeof define && define.amd
          ? define(["exports"], e)
          : e(((t = "undefined" != typeof globalThis ? globalThis : t || self).mdb = {}));
})(this, function (t) {
    "use strict";
                      ...
                      return function n(s) {
                          ...
                          for (let { target: e } = s; e && e !== this; e = e.parentNode)
                              for (let r = o.length; r--; "")
                                  if (o[r] === e)
                                      return (s.delegateTarget = e), n.oneOff && D.off(t, s.type, i), i.apply(e, [s]);
                          return null;
                      };
                  })(t, i, n)
                : (function (t, e) {
    ...
    const M = {
        ...
        B = (t) =>
            R(t) ? (t.jquery ? t[0] : t) : "string" == typeof t && t.length > 0 ? document.querySelector(H(t)) : null,
        W = (t) => {
              ...
              : Sn(
                    (function (t) {
                        var e,
                            ...
                            l = -n.scrollTop;
                        return (
                            "rtl" === ln(s || i).direction && (a += Ji(i.clientWidth, s ? s.clientWidth : 0) - o),
    ...
    let vs = class t extends bt {
        ...
        show() {
            ...
            if (
                (this._element.ownerDocument.documentElement.contains(this.tip) ||
                    (n.append(i), ut.trigger(this._element, this.constructor.eventName("inserted"))),
        ...
        hide() {
            ...
            if ((this._getTipElement().classList.remove(ds), "ontouchstart" in document.documentElement))
                for (const t of [].concat(...document.body.children)) ut.off(t, "mouseover", V);
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ("click" === e)
                    ...
                    const t =
                            e === ps ? this.constructor.eventName("mouseenter") : this.constructor.eventName("focusin"),
                        i =
                            e === ps
    ...
    let Is = class t extends bt {
        ...
        _activateParents(t) {
            if (t.classList.contains("dropdown-item"))
                ...
                for (const e of Rt.parents(t, ".nav, .list-group")) for (const t of Rt.prev(e, Ns)) t.classList.add($s);
        }
        _clearActiveClass(t) {
    ...
    class Ws extends Is {
        ...
        _init() {
            this._bindActivateEvent(),
                ...
                0 !== this._collapsibles.length && (this._showSubsection(), this._hideSubsection());
        }
        _getHeight(t) {
    ...
    class vo extends ao {
        ...
        show() {
            ...
            let i = null,
                n = null;
            e &&
                ((i = D.trigger(e, "hide.bs.tab", { relatedTarget: t })), (n = D.trigger(e, po, { relatedTarget: t })));
        ...
        _getElements(t) {
            ...
            if (
                (t &&
                    ...
                    (this._label = S.findOne("label", this._element)),
                    (e = M.getDataAttribute(this._element, `${this.constructor.NAME}-initialized`))),
                e && t && this._label)
            ) {
                const e = this._labelWidth;
                this._getLabelData(),
                    e !== this._labelWidth &&
                        ((this._notchMiddle = S.findOne(".form-notch-middle", t.target.parentNode)),
    ...
    let Nr = class t extends bt {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    Rt.next(this._element, Ar)[0] || Rt.prev(this._element, Ar)[0] || Rt.findOne(Ar, this._parent)),
        ...
        show() {
            ...
            if (!ut.trigger(this._element, br, t).defaultPrevented) {
                if (
                    ...
                    for (const t of [].concat(...document.body.children)) ut.on(t, "mouseover", V);
                this._element.focus(),
        ...
        _selectMenuItem({ key: t, target: e }) {
            const i = Rt.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", this._menu).filter((t) =>
                W(t)
            );
        ...
        static dataApiKeydownHandler(e) {
            ...
            const o = this.matches(wr)
                    ? this
                    : Rt.prev(this, wr)[0] || Rt.next(this, wr)[0] || Rt.findOne(wr, e.delegateTarget.parentNode),
    ...
    class Kr extends Nr {
        ...
        _bindShowEvent() {
            D.on(this._element, zr, (t) => {
                D.trigger(this._element, Fr, { relatedTarget: t.relatedTarget }).defaultPrevented
                    ? t.preventDefault()
    ...
    class oa extends Bo {
        ...
        _autoInit(t) {
            ...
            if (!this._element.classList.contains("btn") || !1 !== e.rippleInit) {
                if (((this._options = this._getConfig()), "input" === this._element.tagName.toLowerCase())) {
                    ...
                    if (((this._rippleInSpan = !0), "span" === t.tagName.toLowerCase() && t.classList.contains(Qr)))
                        this._element = t;
                    else {
                ...
                this._element.style.minWidth ||
                    (M.style(this._element, { "min-width": `${getComputedStyle(this._element).width}` }),
                ...
                (this._rippleTimer = setTimeout(() => {
                    t &&
                        ...
                        this._element &&
                            ...
                            this._isMinWidthSet &&
                                (M.style(this._element, { "min-width": "" }), (this._isMinWidthSet = !1)),
        ...
        _getDiameter({ offsetX: t, offsetY: e, height: i, width: n }) {
            ...
            let f = 0;
            return (
                a || d ? (f = u.topLeft) : h ? (f = u.topRight) : c ? (f = u.bottomRight) : l && (f = u.bottomLeft),
                2 * f
            );
        }
        _appendRipple(t, e) {
        ...
        _colorToRGB(t) {
            return "transparent" === t.toLowerCase()
                ? ea
                : "#" === t[0]
                  ? ((e = t).length < 7 && (e = `#${e[1]}${e[1]}${e[2]}${e[2]}${e[3]}${e[3]}`),
